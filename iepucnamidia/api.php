 ...
 * Teste da API: http://seusite.com/mysql_api_backend.php?action=count
 * 
...
define('DB_NAME', 'iepuc_db_dev');  // Nome do banco de dados
define('DB_USER', 'usr_materia');        // ALTERE: Seu usuário MySQL
define('DB_PASS', '3M2siKXmHCKIzuuj');           // ALTERE: Sua senha MySQL
